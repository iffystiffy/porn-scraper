...
var Actor = /** @class */ (function () {
    ...
    Actor.prototype.info = function () {
        ...
        return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
            var result, info, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, index_1.search(this.name)];
                    case 1:
                        result = _a.sent();
                        if (!result.femaleStars.length) {
                            return [2 /*return*/, reject("Star not found!")];
                        }
                        return [4 /*yield*/, index_1.getStar(result.femaleStars[0].url)];
                    case 2:
                        info = _a.sent();
